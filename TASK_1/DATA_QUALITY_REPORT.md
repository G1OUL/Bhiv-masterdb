...
3. One inconsistent write-off row was quarantined rather than guessed.
...
7. Deterministic validation was applied.
...
The cleaned dataset and evidence are prepared for the later MASTERDB integration. Kaggle is the designated placeholder connector for Integration Day; it is not being claimed as the authoritative provenance source.